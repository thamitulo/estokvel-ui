"use strict";
(self["webpackChunkestokvel_ui"] = self["webpackChunkestokvel_ui"] || []).push([["src_app_pages_legal_legal_component_ts"],{
...
class LegalComponent {
  static #_ = _staticBlock = () => (this.ɵfac = function LegalComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || LegalComponent)();
  }, this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
    type: LegalComponent,
    selectors: [["app-legal"]],
    decls: 2,
    vars: 0,
    template: function LegalComponent_Template(rf, ctx) {
      if (rf & 1) {
...
//# sourceMappingURL=src_app_pages_legal_legal_component_ts.js.map